...
void BME280_Init(void) {
	...
	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, cmd, 2,
			BME280_I2C_TIMEOUT);
	...
	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, cmd, 1,
			BME280_I2C_TIMEOUT);
	HAL_I2C_Master_Receive(&BME280_I2C, BME280_ADDR, cmd, 6,
			BME280_I2C_TIMEOUT);
	...
	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, cmd, 1,
			BME280_I2C_TIMEOUT);
	HAL_I2C_Master_Receive(&BME280_I2C, BME280_ADDR, cmd, 18,
			BME280_I2C_TIMEOUT);
	...
	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, cmd, 1,
			BME280_I2C_TIMEOUT);
	HAL_I2C_Master_Receive(&BME280_I2C, BME280_ADDR, cmd, 1,
			BME280_I2C_TIMEOUT);

	cmd[1] = 0xE1; // read dig_H regs

	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, &cmd[1], 1,
			BME280_I2C_TIMEOUT);
	HAL_I2C_Master_Receive(&BME280_I2C, BME280_ADDR, &cmd[1], 7,
			BME280_I2C_TIMEOUT);
...
float BME280_getTemperature(void) {
	...
	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, cmd, 1,
			BME280_I2C_TIMEOUT);
	HAL_I2C_Master_Receive(&BME280_I2C, BME280_ADDR, &cmd[1], 3,
			BME280_I2C_TIMEOUT);
...
float BME280_getHumidity(void) {
	...
	HAL_I2C_Master_Transmit(&BME280_I2C, BME280_ADDR, cmd, 1,
			BME280_I2C_TIMEOUT);
	HAL_I2C_Master_Receive(&BME280_I2C, BME280_ADDR, &cmd[1], 2,
			BME280_I2C_TIMEOUT);
	...
	v_x1 = (v_x1
			- (((((v_x1 >> 15) * (v_x1 >> 15)) >> 7) * (int32_t) dig_H1) >> 4));
	v_x1 = (v_x1 < 0 ? 0 : v_x1);
